...
const char HTTP_RFID_MAIN[]        PROGMEM = "<h1>{t}</h1>";

const char * const HTTP_PORTAL_MENU[] PROGMEM = {
"<form action='/wifi'    method='get'><button>Configure WiFi</button></form><br/>\n", // MENU_WIFI
"<form action='/0wifi'   method='get'><button>Configure WiFi (No scan)</button></form><br/>\n", // MENU_WIFINOSCAN
"<form action='/rfid'  method='get'><button>Configure RFID</button></form>\n", // MENU_CONFIG
"<form action='/info'    method='get'><button>Info</button></form><br/>\n", // MENU_INFO
"<form action='/param'   method='get'><button>Setup</button></form><br/>\n",//MENU_PARAM
"<form action='/close'   method='get'><button>Close</button></form><br/>\n", // MENU_CLOSE
"<form action='/restart' method='get'><button>Restart</button></form><br/>\n",// MENU_RESTART
"<form action='/exit'    method='get'><button class='D'>Exit</button></form><br/>\n",  // MENU_EXIT
...
const char HTTP_RFID_CONFIG[]      PROGMEM = "<form method='POST' action='/rfidsave'><label for='endpoint'>Endpoint</label> <input id='endpoint' name='endpoint' maxlength='32' autocorrect='off' autocapitalize='none' placeholder=''><br/><br/><label for='power'>Power dBm</label><input id='power' name='power' maxlength='32' autocorrect='off' autocapitalize='none' placeholder=''><br/><br/><label for='send'>Send Timer</label><input id='send' name='send' maxlength='32' autocorrect='off' autocapitalize='none' placeholder=''><br/><br/><label for='clear'>Clear Timer</label><input id='clear' name='clear' maxlength='32' autocorrect='off' autocapitalize='none' placeholder=''><br/><br/><button type='submit'>Save</button></form></br>";
...
const char HTTP_FORM_END[]         PROGMEM = "<br/><br/><button type='submit'>Save</button></form></br>";
const char HTTP_FORM_LABEL[]       PROGMEM = "<label for='{i}'>{t}</label>";
const char HTTP_FORM_PARAM_HEAD[]  PROGMEM = "<hr><br/>";
const char HTTP_FORM_PARAM[]       PROGMEM = "<br/><input id='{i}' name='{n}' maxlength='{l}' value='{v}' {c}>\n"; // do not remove newline!

const char HTTP_SCAN_LINK[]        PROGMEM = "<br/><form action='/wifi?refresh=1' method='POST'><button name='refresh' value='1'>Refresh</button></form>";
const char HTTP_SAVED[]            PROGMEM = "<div class='msg'>Saving Credentials<br/>ESP Successfully Connected to Network</div>";
const char HTTP_NOT_SAVED[]        PROGMEM = "<div class='msg'>Failed to Connect ESP to Network</div>";
...
const char HTTP_BACKBTN[]          PROGMEM = "<hr><br/><form action='/' method='get'><button>Go Back</button></form>";
const char HTTP_TRYAGAIN[]         PROGMEM = "<br/><form action='/wifi' method='get'><button>Try Again</button></form>";
...
const char S_titlerfid[]          PROGMEM = "Config RFID";
