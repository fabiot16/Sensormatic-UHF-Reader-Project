...
class WiFiManager
{
  ...
  private:
    ...
    unsigned long _connectTimeout         = 10; // ms stop trying to connect to ap if set
    unsigned long _saveTimeout            = 10; // ms stop trying to connect to ap on saves, in case bugs in esp waitforconnectresult
